...
- measure:
  ...
  `"core"`. All four by default. Abbreviations work (`"jac"`),
  duplicates are ignored, and the columns come back in the order above
  whatever order you ask in. A value that matches none of the four is an
